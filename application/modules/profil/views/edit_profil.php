...
<body>
    ...
    <div class="topnav" id="myTopnav">
        ...
        <a href="<?php echo base_url('Profil/Daftar_Profil') ?>">Data Mahasiswa</a></i>
    ...
    <div class="row" style="margin-left: 10px; margin-right: 30px;">
        <div class="card col-sm-12" style="padding-right: 30px;">
            <div class="card col-sm-12">
                ...
                <div class="card-body">
                    <form action="<?php echo base_url('Profil/fungsiEdit') ?>" method="post">
                        ...
                        <a class="btn btn-success" href=" <?php echo base_url('Profil/Lihat_Profil') ?>">Kembali</a>
                    </form>
                </div>
            </div>
        </div><br />
