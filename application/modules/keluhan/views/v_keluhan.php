...
<body>
    ...
    <div class="topnav" id="myTopnav">
        ...
        <a href="<?php echo base_url('Hadir/hadir_admin') ?>">Daftar Hadir</a></i>
            ...
            <div class="card col-sm-12">
                ...
                <div class="card-body">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <td>
                                <center><?php echo $row->id_keluhan ?></center>
                            </td>
                            <td>
                                <center><?php echo $row->nim_mhs ?></center>
                            </td>
                            <td>
                                <center><?php echo $row->nama_mhs ?></center>
                            </td>
                            <td>
                            ...
                            <center>
                                <td width="110px">
                                    ...
                                    <a class="btn bg-warning" href="<?php echo base_url('Keluhan/edit_keluhan') ?>/<?php echo $row->id_keluhan ?>"><i class="fas fa-edit"></a></i> <a class="btn bg-danger text-white" href="<?php echo base_url('Keluhan/fungsiDeleteAdmin') ?>/<?php echo $row->id_keluhan ?>"><i class="fas fa-trash"></a></i>
