                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a class=" btn bg-warning" href=" <?php echo base_url('Hadir/edit_hadir') ?>/<?php echo $row->id_hadir ?>"><i class="fa fa-edit"></a></i>
                                    <a class="btn bg-danger text-white" href="<?php echo base_url('Hadir/fungsiDeleteAdmin') ?>/<?php echo $row->id_hadir ?>"><i class="fa fa-trash"></a></i>
                                </td>
                            </tr>
                        <?php } ?>
                    </table><br />
